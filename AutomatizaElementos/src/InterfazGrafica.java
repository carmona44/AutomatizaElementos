...
public class InterfazGrafica extends JFrame{
	...
	private JTextField codigo, ano, fichero;
	...
	InterfazGrafica(){
		...
		personaFisica.setBounds(100,100,100,30);  
		personaJuridica = new JRadioButton("Jurídica");
		personaJuridica.setBounds(100,150,100,30);
		personaMixta = new JRadioButton("Mixta");
		personaMixta.setBounds(100,200,100,30);
